...
public class FreeFlyCamera : MonoBehaviour
{
    ...
    public Vector3 mockPosition = Vector3.zero;
    public Quaternion mockRotation = Quaternion.identity;
    ...
    private void Start()
    {
        ...
        // Setup mock stuff
        mockPosition = transform.position;
        mockRotation = transform.rotation;
    }
    ...
    private void Update()
    {
        ...
        if (_enableMovement)
        {
            ...
            if (canMove)
            {
                mockPosition += deltaPosition * (currentSpeed * _currentIncrease);
            }
        }
        ...
        {
            mockPosition = _initPosition;
            mockRotation.eulerAngles = _initRotation;
        }
    }
}
